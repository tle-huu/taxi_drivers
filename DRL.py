...
def dimensions_after_pooling(grid_shape, channels_number):
    return channels_number * (grid_shape[0] * grid_shape[1]) / 4
...
class CarLeader(nn.Module):
    ...
    def __init__(self, cars_number, hidden_channels, grid_shape):
        ...
        features = int(dimensions_after_pooling(grid_shape, hidden_channels))
